...
以下は、ミニ四駆用ターミナルを加工し、本基板へ配線する場合の一例です。
使用するシャーシやターミナル形状により加工位置が変わる可能性があります。実際の導通・絶縁は、必ずテスターで確認してください。

> **注意**
> 電池端子、モーター端子、基板が意図せずショートすると、基板・電池・モーターを破損する可能性があります。
> 配線後は、電池を入れる前に必ず導通確認・絶縁確認を行ってください。

### 片軸モーターシャーシのターミナル加工例

VZ、VS、AR、S2など、片軸モーターを使用するシャーシ向けの加工例です。
...
<img src="terminal_cutting.png" alt="片軸モーターシャーシ用ターミナル加工例" width="500">
...
<img src="terminal_wiring.png" alt="ターミナル配線例" width="500">

### MA・MS・MEシャーシ（両軸モーター）のターミナル加工例

MA、MS、MEシャーシなど、両軸モーターを使用するシャーシ向けの加工例です。
赤い破線で示した部分を切断し、中央の不要な端子部分は使用しません。

加工後は、以下の接続になるように配線します。
...
<img src="terminal_cutting_MS_MA_ME.png" alt="MA・MS・MEシャーシ用ターミナル加工例" width="500">
...
<img src="terminal_to_board.jpg" alt="基板への配線例" width="500">
